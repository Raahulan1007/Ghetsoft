...
function Init() --The strategy profile initialization
    strategy:name("MTF correct Sfk  + Bar-Color + increment + MVA");
	...
	strategy.parameters:addInteger("HA1 Periods", "HA1 Periods", "HA1 Periods", 1)	
	strategy.parameters:addInteger("SFK2 KPeriods", "SFK2 KPeriods", "SFK2 KPeriods", 5)
        ...
        strategy.parameters:addInteger("MVA1 Periods", "MVA1 Periods", "MVA1 Periods", 1)
        strategy.parameters:addInteger("MVA2 Periods", "MVA2 Periods", "MVA2 Periods", 1)
...
--~ 	
	...
	HA1 = core.indicators:create("HA", Source1, N1);	
	SFK2 = core.indicators:create("SFK",  Source2, N2);	
	MVA1 = core.indicators:create("MVA", Source1.close, instance.parameters["MVA1 Periods"]);
        MVA2 = core.indicators:create("MVA", Source1.open, instance.parameters["MVA2 Periods"]);	
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	if  SFK2.K[period2]>SFK2.D[period2]   and
	    HA1.close[period1] > HA1.open[period1] and
	    MVA1.MVA[period1] > MVA2.MVA[period1] and
	    HA1.close[period1] > HA1.open[period1 - 1]
...
--~ 	    
	 ...
	 then
       ...
       if 
	    SFK2.K[period2]<SFK2.D[period2]   and
	    HA1.close[period1] < HA1.open[period1] and
	    MVA1.MVA[period1] < MVA2.MVA[period1] and
	    HA1.close[period1] < HA1.open[period1 - 1]
