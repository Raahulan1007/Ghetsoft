...
function Init() --The strategy profile initialization
    strategy:name("MTF DMI(16)Strategy");
...
--~     strategy.parameters:addInteger("SFK1 KPeriods", "SFK1 KPeriods", "SFK1 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK1 DPeriods", "SFK1 DPeriods", "SFK1 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK2 KPeriods", "SFK2 KPeriods", "SFK2 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK2 DPeriods", "SFK2 DPeriods", "SFK2 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK3 KPeriods", "SFK3 KPeriods", "SFK3 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK3 DPeriods", "SFK3 DPeriods", "SFK3 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK4 KPeriods", "SFK4 KPeriods", "SFK4 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK4 DPeriods", "SFK4 DPeriods", "SFK4 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK5 KPeriods", "SFK5 KPeriods", "SFK5 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK5 DPeriods", "SFK5 DPeriods", "SFK5 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK6 KPeriods", "SFK6 KPeriods", "SFK6 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK6 DPeriods", "SFK6 DPeriods", "SFK6 DPeriods", 5)
--~     
    
--~     strategy.parameters:addInteger("SFK7 KPeriods", "SFK7 KPeriods", "SFK7 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK7 DPeriods", "SFK7 DPeriods", "SFK7 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK8 KPeriods", "SFK8 KPeriods", "SFK8 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK8 DPeriods", "SFK8 DPeriods", "SFK8 DPeriods", 5)
--~     
--~     
--~     strategy.parameters:addInteger("SFK9 KPeriods", "SFK9 KPeriods", "SFK9 KPeriods", 5)
--~     strategy.parameters:addInteger("SFK9 DPeriods", "SFK9 DPeriods", "SFK9 DPeriods", 5)
--~     
     ...
     strategy.parameters:addInteger("DMI4 Periods", "DMI4 Periods", "DMI4 Periods", 4)
     strategy.parameters:addInteger("DMI5 Periods", "DMI5 Periods", "DMI5 Periods", 4)
     strategy.parameters:addInteger("DMI6 Periods", "DMI6 Periods", "DMI6 Periods", 4)
...
--~ 	strategy.parameters:addDouble("SL1", "Sell Level", "Level", 80);
	...
	strategy.parameters:addString("TF2", "Time frame", "", "m5");
...
--~ 	strategy.parameters:addDouble("SL2", "Sell Level", "Level", 80);
    ...
    strategy.parameters:addString("TF3", "Time frame", "", "m15");
...
--~       strategy.parameters:addString("TF7", "Time frame", "", "H4");
...
--~       strategy.parameters:addString("TF8", "Time frame", "", "H6");
...
--~       strategy.parameters:addString("TF9", "Time frame", "", "H8");
...
local Source, Source1, Source2, Source3, Source4, Source5, Source6;
...
--~ 	SFK1 = core.indicators:create("SFK",  Source1, instance.parameters["SFK1 Periods"]);	
--~ 	SFK2 = core.indicators:create("SFK",  Source2, instance.parameters["SFK2 Periods"]);
--~ 	SFK3 = core.indicators:create("SFK",  Source3, instance.parameters["SFK3 Periods"]);	
--~ 	SFK4 = core.indicators:create("SFK",  Source4, instance.parameters["SFK4 Periods"]);
--~ 	SFK5 = core.indicators:create("SFK",  Source5, instance.parameters["SFK5 Periods"]);	
--~ 	SFK6 = core.indicators:create("SFK",  Source6, instance.parameters["SFK6 Periods"]);
--~ 	SFK7 = core.indicators:create("SFK",  Source7, instance.parameters["SFK7 Periods"]);	
--~ 	SFK8 = core.indicators:create("SFK",  Source8, instance.parameters["SFK8 Periods"]);
--~ 	SFK9 = core.indicators:create("SFK",  Source9, instance.parameters["SFK9 Periods"]);	
...
--~ 	SFK1:update(core.UpdateLast);
--~         SFK2:update(core.UpdateLast); 
--~ 	SFK3:update(core.UpdateLast);
--~         SFK4:update(core.UpdateLast); 
--~ 	SFK5:update(core.UpdateLast);
--~         SFK6:update(core.UpdateLast); 
--~ 	SFK7:update(core.UpdateLast);
--~         SFK8:update(core.UpdateLast); 
--~ 	SFK9:update(core.UpdateLast);
	 ...
	 if DMI1.DIP[period1]>DMI1.DIM[period1] and DMI2.DIP[period2]>DMI2.DIM[period2] and DMI3.DIP[period3]>DMI3.DIM[period3] and
	    DMI4.DIP[period4]>DMI4.DIM[period4] and DMI5.DIP[period5]>DMI5.DIM[period5] and DMI6.DIP[period6]>DMI6.DIM[period6]
...
--~ 	    core.crossesOver(SFK1.K, SFK1.D, period1) and    
--~ 	    core.crossesOver(SFK2.K, SFK2.D, period2) and
--~ 	    core.crossesOver(SFK3.K, SFK3.D, period3) and
--~ 	    core.crossesOver(SFK4.K, SFK4.D, period4) and
--~ 	    core.crossesOver(SFK5.K, SFK5.D, period5) and
--~ 	    core.crossesOver(SFK6.K, SFK6.D, period6) 
--~ 	    core.crossesOver(SFK7.K, SFK7.D, period7) and
--~ 	    core.crossesOver(SFK8.K, SFK8.D, period8) and
--~ 	    core.crossesOver(SFK9.K, SFK9.D, period9) 
...
--~             core.crossesUnder(SFK1.K, SFK1.D, period1) and    
--~ 	    core.crossesUnder(SFK2.K, SFK2.D, period2) and
--~ 	    core.crossesUnder(SFK3.K, SFK3.D, period3) and
--~ 	    core.crossesUnder(SFK4.K, SFK4.D, period4) and
--~ 	    core.crossesUnder(SFK5.K, SFK5.D, period5) and
--~ 	    core.crossesUnder(SFK6.K, SFK6.D, period6) 
--~ 	    core.crossesUnder(SFK7.K, SFK7.D, period7) and
--~ 	    core.crossesUnder(SFK8.K, SFK8.D, period8) and
--~ 	    core.crossesUnder(SFK9.K, SFK9.D, period9) 
