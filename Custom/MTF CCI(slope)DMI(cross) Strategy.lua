...
function Init() --The strategy profile initialization
    strategy:name("MTF CCI(slope)DMI(cross) Strategy");
    ...
    strategy.parameters:addInteger("DMI1 Periods", "DMI1 Periods", "DMI1 Periods", 2)
    strategy.parameters:addInteger("DMI2 Periods", "DMI2 Periods", "DMI2 Periods", 4)
    
    strategy.parameters:addInteger("CCI1 Periods", "CCI1 Periods", "CCI1 Periods", 7)
    strategy.parameters:addInteger("CCI2 Periods", "CCI2 Periods", "CCI2 Periods", 14)
    strategy.parameters:addInteger("CCI3 Periods", "CCI3 Periods", "CCI3 Periods", 7)
    strategy.parameters:addInteger("CCI4 Periods", "CCI4 Periods", "CCI4 Periods", 14)   
    
    
	
    strategy.parameters:addGroup("1. Time Frame");
    strategy.parameters:addString("TF1", "Time frame", "", "H3");
...
--~ 	s3, e3 = core.getcandle(instance.parameters.TF3, core.now(), 0, 0);
        ...
        assert ((e - s) < (e2 - s2), "The chosen time frame must be  bigger than the chart time frame!");
--~ 	assert ((e - s) < (e3 - s3), "The chosen time frame must be  bigger than the chart time frame!");
...
--~ 	Source3 = ExtSubscribe(4, nil, instance.parameters.TF3, instance.parameters.Type == "Bid", "bar");
	...
	CCI1 = core.indicators:create("CCI",  Source1, N1);
	CCI2 = core.indicators:create("CCI",  Source1, N1);
	
	CCI3 = core.indicators:create("CCI",  Source2, N2);
	CCI4 = core.indicators:create("CCI",  Source2, N2);
        DMI1 = core.indicators:create("DMI", Source2, N2);
	DMI2 = core.indicators:create("DMI", Source2, N2);
...
--~ 	or  period3 == -1
	...
	DMI2:update(core.UpdateLast);
	 ...
	 if  CCI1.CCI[period1]>CCI1.CCI[period1-1] and  CCI2.CCI[period1]>CCI2.CCI[period1-1] and
	     CCI3.CCI[period2]>CCI3.CCI[period2-1] and CCI4.CCI[period2]>CCI4.CCI[period2-1] and
	     
	     core.crossesOver(DMI1.DIP,DMI1.DIM,period2) and core.crossesOver(DMI2.DIP,DMI2.DIM,period2)
	 ...
	 then
		...
		ONE= Source:serial(period);
	     ...
	     core.crossesUnder(DMI1.DIP,DMI1.DIM,period2) and core.crossesUnder(DMI2.DIP,DMI2.DIM,period2)
	then
            if Direction then
                SELL();
            else
