...
function Init() --The strategy profile initialization
    strategy:name("MTF DMI(12) Strategy");
...
--~      strategy.parameters:addInteger("DMI3 Periods", "DMI3 Periods", "DMI3 Periods", 2)
...
--~ 	DMI11:update(core.UpdateLast);
	 ...
	 if DMI1.DIP[period1]>DMI1.DIM[period1] and DMI2.DIP[period2]>DMI2.DIM[period2]
