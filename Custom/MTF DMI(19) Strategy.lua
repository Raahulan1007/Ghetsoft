...
function Init() --The strategy profile initialization
    strategy:name("MTF DMI(19) Strategy");
    ...
    strategy.parameters:setFlag("TF", core.FLAG_PERIODS);
     ...
     strategy.parameters:addInteger("DMI7 Periods", "DMI7 Periods", "DMI7 Periods", 4)
     strategy.parameters:addInteger("DMI8 Periods", "DMI8 Periods", "DMI8 Periods", 4)
     strategy.parameters:addInteger("DMI9 Periods", "DMI9 Periods", "DMI9 Periods", 4)
...
function CreateTradingParameters()
   ...
   -- strategy.parameters:addStringAlternative("ExecutionType", "End of Turn", "", "End of Turn");
    ...
    strategy.parameters:addInteger("Amount", "Trade Amount in Lots", "", 5, 1, 1000000);
...
local Source, Source1, Source2, Source3, Source4, Source5, Source6, Source7, Source8, Source9;
...
--~ 	DMI11:update(core.UpdateLast);
	 ...
	 if DMI1.DIP[period1]>DMI1.DIM[period1] and DMI2.DIP[period2]>DMI2.DIM[period2] and DMI3.DIP[period3]>DMI3.DIM[period3] and
	    DMI4.DIP[period4]>DMI4.DIM[period4] and DMI5.DIP[period5]>DMI5.DIM[period5] and DMI6.DIP[period6]>DMI6.DIM[period6] and
	    DMI7.DIP[period7]>DMI7.DIM[period7] and DMI8.DIP[period8]>DMI8.DIM[period8] and
            DMI9.DIP[period9]>DMI9.DIM[period9] 
--~          
