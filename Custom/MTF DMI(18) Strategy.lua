...
function Init() --The strategy profile initialization
    strategy:name("MTF DMI(18) Strategy");
...
local Source, Source1, Source2, Source3, Source4, Source5, Source6, Source7, Source8;
...
--~ 	DMI11:update(core.UpdateLast);
	 ...
	 if DMI1.DIP[period1]>DMI1.DIM[period1] and DMI2.DIP[period2]>DMI2.DIM[period2] and DMI3.DIP[period3]>DMI3.DIM[period3] and
	    ...
	    DMI7.DIP[period7]>DMI7.DIM[period7] and DMI8.DIP[period8]>DMI8.DIM[period8]
