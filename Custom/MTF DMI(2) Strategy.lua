...
function Init() --The strategy profile initialization
    strategy:name("MTF DMI[2] Strategy");
   ...
   strategy.parameters:addInteger("N3", "Period", "Period", 4, 1, 1000);
...
function Prepare(nameOnly)
	...
	Source3 = ExtSubscribe(4, nil, instance.parameters.TF3, instance.parameters.Type == "Bid", "bar");
        ...
        DMI1 = core.indicators:create("DMI", Source1[Price1],  instance.parameters["DMI1 Periods"]);
	DMI2 = core.indicators:create("DMI", Source2[Price2],  instance.parameters["DMI2 Periods"]);
	DMI3 = core.indicators:create("DMI", Source3[Price3],  instance.parameters["DMI3 Periods"]);
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	DMI3:update(core.UpdateLast);
	 ...
	 if DMI1.DIP.DATA[ period1]>DMI1.DIP.DATA[period1-1]
	...
	if Exit then
		            if      DMI2.DATA[period2] >  DMI3.DATA[period3]
					then 			
								if   Direction then
